...
var serverApi = __webpack_require__(131);
...
var store = {
  ...
  updateWeatherCities: function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var weatherList, response, result, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item;

      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              weatherList = void 0, response = void 0, result = [];
              _context2.prev = 1;
              _context2.next = 4;
            ...
            case 13:
              ...
              item = _step.value;
              _context2.next = 17;
              return serverApi.getWeather(item._name);
      ...
      }, _callee2, this, [[1, 44], [11, 30, 34, 42], [35,, 37, 41]]);
    }));
  ...
  setWeatherCard: function setWeatherCard(response, num) {
    ...
    var lastUpdate = new Date(response.lastBuildDate.match(/(.+?M)/)[0]);
  ...
  init: function init() {
    ...
    pubsub.subscribe('delete-card', function (data) {
      ...
      storage.deleteItem(id).then(function (response) {
        if (!response) showMessage('unknow');else {
          ...
          if (index < 0) console.error('nonexistent geo name ' + card);else _this.weatherFor.splice(index, 1);
        }
      });
    });
    ...
    pubsub.subscribe('change-current-city', function (data) {
      ...
      storage.setCurrentSity(id).then(function (response) {
        ...
        _this.currentCitiId = response.id;
        pubsub.publish('create-card-weater', response.city);
      });
    });
  },
  updateAllWeather: function updateAllWeather() {
    var _this2 = this;

    if (!this.onlineStatus) return showMessage('offline');
    pubsub.publish('start-updated-all-weather-card');
    this.updateWeatherCities().then(function (response) {
      if (!response) {
        pubsub.publish('end-updated-all-weather-card');
        return showMessage('unknow');
      } else {
        response = response.map(function (item) {
          return _this2.setWeatherCard(item, item.id);
        });
        storage.updateAllWeather(response).then(function (response) {
          if (!response) return showMessage('unknow');
          response.some(function (item) {
            if (item.id === _this2.currentCitiId) {
  ...
  changeCurrentCity: function changeCurrentCity(id) {
    ...
    storage.setCurrentSity(id).then(function (response) {
      if (!response) showMessage('unknow');
      _this3.currentCitiId = response.id;
    });
  },
  initApp: function initApp() {
    ...
    storage.init(this.settings).then(function (response) {
      ...
      _this4.weatherFor = listWeather.map(function (item) {
        return item.geonameid;
      });
      _this4.isCardWeather = listWeather.length > 0 ? true : false;
      _this4.showHidePulsing(_this4.isCardWeather);
      _this4.currentCitiId = response.currentSity;
      pubsub.publish('create-list-saved-sities', listWeather);

      listWeather.some(function (item) {
        if (item.id === _this4.currentCitiId) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              YQL = 'select * from weather.forecast where woeid in (select woeid from geo.places(1) where text="' + place + '")';
...
var localforage = __webpack_require__(364);
...
module.exports = {
  ...
  updateAllWeather: function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 17:
              return _context2.abrupt('return', response ? response.listWeather : response);
    ...
    function updateAllWeather(_x2) {
      return _ref2.apply(this, arguments);
    }

    return updateAllWeather;
  }(),
  deleteItem: function () {
...
var serverApi = __webpack_require__(131);
var storage = __webpack_require__(137);
var WeathersList = __webpack_require__(365);
var Header = __webpack_require__(368);
var BlockSearch = __webpack_require__(369);
var ListSities = __webpack_require__(371);
var Message = __webpack_require__(373);
var NotFound = __webpack_require__(374);
var Menu = __webpack_require__(375);
var SavedCities = __webpack_require__(376);
...
var pubsub = new (__webpack_require__(18))();
var getParentNode = __webpack_require__(95);
var format = __webpack_require__(366);
var store = __webpack_require__(130);
var Preloader = __webpack_require__(138);
var CODES = __webpack_require__(367);
var INTERVAL = 300000; // 5 min in ms
var FIRST_TIME_UPDATED = 60000; // 1 min in ms
var MAX_TIME_UPDATED = 5; // hours
...
var WeathersList = function () {
  ...
  _createClass(WeathersList, [{
    ...
    value: function createCardWeater(data) {
      ...
      this.firstIntervalId = setTimeout(function () {
        _this.updatedTimeElem.innerHTML = 'over 1 minute ago';
      }, FIRST_TIME_UPDATED);
    }
  }, {
    ...
    value: function getLastUpdateTime() {
      ...
      this.intervalId = setInterval(function () {
        time = format.convertMS(Date.now() - _this2._updated);
        if (time.hours < MAX_TIME_UPDATED) {
          time = time.hours < 1 ? time.minutes + 'm ago' : time.hours + 'h ' + time.minutes + 'm ago';
          _this2.updatedTimeElem.innerHTML = time;
        } else {
          clearInterval(_this2.intervalId);
          _this2.updatedTimeElem.innerHTML = 'over ' + MAX_TIME_UPDATED + ' hours ago';
        }
      }, INTERVAL);
    }
  }, {
    ...
    value: function updateTimeFormat(list) {
      ...
      list.forEach(function (data) {
        card = _this5.container.querySelector('[data-id="' + data.id + '"]');
...
var pubsub = new (__webpack_require__(18))();
var ButtonImg = __webpack_require__(48);
...
var pubsub = new (__webpack_require__(18))();
var InputSearch = __webpack_require__(370);
var ButtonImg = __webpack_require__(48);
var Preloader = __webpack_require__(138);
var ESC = 27; // keyCode;
...
var pubsub = new (__webpack_require__(18))();
var SelectItemList = __webpack_require__(372);
...
var pubsub = new (__webpack_require__(18))();
var ButtonImg = __webpack_require__(48);
var Swipedetect = __webpack_require__(139);
var ESC = 27; // keyCode
