...
/***/ "./src/js/components/BlockSearch.js":
/*!******************************************!*\
  !*** ./src/js/components/BlockSearch.js ***!
  \******************************************/
...
var pubsub = new (__webpack_require__(/*! ../utils/pubSub */ "./src/js/utils/pubSub.js"))();
var InputSearch = __webpack_require__(/*! ./InputSearch */ "./src/js/components/InputSearch.js");
var ButtonImg = __webpack_require__(/*! ./ButtonImg */ "./src/js/components/ButtonImg.js");
var Preloader = __webpack_require__(/*! ./Preloader */ "./src/js/components/Preloader.js");
var ESC = 27; // keyCode;
var TIME_ANIMATION = 250; //ms
var BlockSearch = /*#__PURE__*/function () {
  ...
  _createClass(BlockSearch, [{
    ...
    value: function newSubstring(event) {
      ...
      pubsub.publish('new-substring-on-search-cityes', {
        key: substring
      });
    }
  }]);
...
/***/ "./src/js/components/ButtonImg.js":
/*!****************************************!*\
  !*** ./src/js/components/ButtonImg.js ***!
  \****************************************/
/***/ (function(module) {
...
var ButtonImg = /*#__PURE__*/function () {
  ...
  _createClass(ButtonImg, [{
    ...
    value: function createButton(conf) {
      ...
      btn.className = "".concat(conf.className, " ").concat(DEFAULT_CLASSNAME);
...
/***/ "./src/js/components/InputSearch.js":
/*!******************************************!*\
  !*** ./src/js/components/InputSearch.js ***!
  \******************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./src/js/components/ListSities.js":
/*!*****************************************!*\
  !*** ./src/js/components/ListSities.js ***!
  \*****************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var pubsub = new (__webpack_require__(/*! ../utils/pubSub */ "./src/js/utils/pubSub.js"))();
var SelectItemList = __webpack_require__(/*! ../utils/SelectItemList */ "./src/js/utils/SelectItemList.js");
var ListSities = /*#__PURE__*/function () {
  ...
  _createClass(ListSities, [{
    ...
    value: function createListCityes(list) {
      ...
      var result = list.reduce(function (previousItem, item, index) {
        previousItem += "\n      <li\n        class=\"itemListSities\"\n        data-index=".concat(index, "\n        data-full-name=\"").concat(item.matching_full_name, "\">\n        ").concat(item.matching_full_name, "\n      </li>");
        return previousItem;
      }, '');
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var getParentNode = __webpack_require__(/*! ../utils/getParentNode */ "./src/js/utils/getParentNode.js");
var pubsub = new (__webpack_require__(/*! ../utils/pubSub */ "./src/js/utils/pubSub.js"))();
var ButtonImg = __webpack_require__(/*! ./ButtonImg */ "./src/js/components/ButtonImg.js");
var Swipedetect = __webpack_require__(/*! ../utils/Swipedetect */ "./src/js/utils/Swipedetect.js");
var ESC = 27; // keyCode
...
var Menu = /*#__PURE__*/function () {
  ...
  _createClass(Menu, [{
    ...
    value: function setCurrentValue(data) {
      ...
      var key;
      for (key in settings) {
        item = this.container.querySelector("input[value=\"".concat(settings[key], "\"]"));
...
var NotFound = /*#__PURE__*/function () {
  function NotFound(data) {
    ...
    pubsub.subscribe("disabled-".concat(data.eventName), this.disabled);
    pubsub.subscribe("enabled-".concat(data.eventName), this.enabled);
  }
...
/***/ "./src/js/components/SavedCities.js":
/*!******************************************!*\
  !*** ./src/js/components/SavedCities.js ***!
  \******************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
var ESC = 27; // keyCode
var store = __webpack_require__(/*! ../store */ "./src/js/store.js");
var SavedCities = /*#__PURE__*/function () {
  function SavedCities(data) {
    ...
    this.listSities.addEventListener('click', function (event) {
      ...
      if (target.tagName === 'LI') {
        ...
        _this.toggleActiveItem(_this.activeItem);
        pubsub.publish('change-current-city', {
  ...
  _createClass(SavedCities, [{
    ...
    value: function swipedMove(direction, pageX, target) {
      var _pageX = pageX < 0 ? -pageX : pageX;
      if (_pageX < 20) return;
      target.style.transform = "translateZ(0) translateX(".concat(pageX, "px)");
      target.style.opacity = "".concat(1 - getPercent(1000, _pageX) / 20);
    }
  }, {
    key: "swipedEnd",
    value: function swipedEnd(target, pageX) {
    ...
    value: function showBlock() {
      var target = this.listSities.querySelector("[data-id=\"".concat(store.currentCitiId, "\"]"));
      if (target) {
...
var pubsub = new (__webpack_require__(/*! ../utils/pubSub */ "./src/js/utils/pubSub.js"))();
var getParentNode = __webpack_require__(/*! ../utils/getParentNode */ "./src/js/utils/getParentNode.js");
var format = __webpack_require__(/*! ../utils/format */ "./src/js/utils/format.js");
var store = __webpack_require__(/*! ../store */ "./src/js/store.js");
var Preloader = __webpack_require__(/*! ./Preloader */ "./src/js/components/Preloader.js");
var CODES = __webpack_require__(/*! ../utils/weatherCodes */ "./src/js/utils/weatherCodes.js");
var INTERVAL = 60000; // 1 min in ms
var MAX_TIME_UPDATED = 2; // hours
var WeatherCard = /*#__PURE__*/function () {
  ...
  _createClass(WeatherCard, [{
    ...
    value: function getLastUpdateTime() {
      ...
      if (time.hours < MAX_TIME_UPDATED) {
        if (time.minutes >= 1) {
          time = time.hours < 1 ? "".concat(time.minutes, "m ago") : "".concat(time.hours, "h ").concat(time.minutes, "m ago");
        } else time = 'less than a minute ago';
      } else {
        clearInterval(this.intervalId);
        time = "over ".concat(MAX_TIME_UPDATED, " hours ago");
      }
    ...
    value: function updateTemperature(list) {
      var _this2 = this;
      var card, forecastList, forecastItems, todayMinMax;
      var temperature = store.settings.temperature;
      list.forEach(function (data) {
        card = _this2.container.querySelector("[data-id=\"".concat(data.id, "\"]"));
    ...
    value: function updateSpeed(list) {
      ...
      list.forEach(function (data) {
        card = _this3.container.querySelector("[data-id=\"".concat(data.id, "\"]"));
        card.querySelector('.visibility').innerHTML = !data.atmosphere.visibility ? 'n/d' : format.getWindStrength(data.atmosphere.visibility, speed, '');
    ...
    value: function updateTimeFormat(list) {
      ...
      list.forEach(function (data) {
        var _data$astronomy = data.astronomy,
          sunrise = _data$astronomy.sunrise,
          sunset = _data$astronomy.sunset;
        card = _this4.container.querySelector("[data-id=\"".concat(data.id, "\"]"));
        card.querySelector("[data-time-update=\"time-update\"]").innerHTML = format.getCurrentTime(new Date(data.localTime), timeFormat);
        card.querySelector('.sunrise').innerHTML = format.getCurrentTime(new Date(sunrise * 1000), timeFormat);
        card.querySelector('.sunset').innerHTML = format.getCurrentTime(new Date(sunset * 1000), timeFormat);
      });
    }
  }]);
  return WeatherCard;
...
function createForecast(list, tempFormat) {
  return list.reduce(function (previousValue, item) {
    var src = CODES[item.code];
    return previousValue + "\n      <li class=\"itemForecast\">\n        <div class=\"cellForecast\">\n          <div class=\"containerDate\">\n            <time class=\"dateForecast\">".concat(format.formateDateForecast(item.date * 1000), "</time>\n          </div>\n          <span class=\"descriptionForecast\">").concat(item.text, "</span>\n        </div>\n        <div class=\"cellForecast\">\n          <img class=\"imgForecast\" src=\"images/weather/").concat(src, ".png\" alt=\"").concat(src, "\"/>\n          <div class=\"containerMinMax\">\n            <div class=\"maxTemperature\">\n              <span class=\"minIcon monospaceNumber\">&#8595;</span>\n              <span class=\"minT monospaceNumber\">").concat(format.convertTemperature(+item.low, tempFormat), "</span>\n            </div>\n            <div class=\"minTemperature\">\n              <span class=\"maxIcon\">&#8593;</span>\n              <span class=\"maxT\">").concat(format.convertTemperature(+item.high, tempFormat), "</span>\n            </div>\n          </div>\n        </div>\n      </li>");
  }, "");
}
;
function templateCard(data) {
  ...
  var src = CODES[item.condition.code];
  var template = "<div class=\"row\">\n        <div class=\"cell\">\n        <div class=\"cityName\">".concat(location.city, "</div>\n        <div class=\"regionName\">").concat(location.regionFullName.trim() === location.city.trim() ? '' : location.regionFullName, "</div>\n        <div class=\"countryName\">").concat(location.country, "</div>\n        <div class=\"containerDate\">\n          <small class=\"content\">").concat(format.formateToday(date), "</small>\n          <small class=\"content monospaceNumber\">\n            <small data-time-update=\"time-update\">\n              ").concat(format.getCurrentTime(new Date(data.localTime), timeFormat), "\n            </small>\n            <small class=\"descriptionTime\">( local time )</small>\n          </small>\n          <small class=\"updatedTime\">\n            updated: <small class=\"time\"></small>\n          </small>\n        </div>\n        <div class=\"blockTemperature\">\n          <div class=\"containerTemperatureToday\">\n            <div class=\"temperatureToday monospaceNumber\">\n              ").concat(format.convertTemperature(+item.condition.temperature, temperature), "\n            </div>\n            <div class=\"containerMinMaxToday\">\n              <div class=\"wrapper\">\n                <small>&#8595;</small>\n                <span class=\"minToday monospaceNumber\">\n                  ").concat(format.convertTemperature(+todayMinMax.low, temperature), "\n                </span>\n              </div>\n              <div class=\"wrapper\">\n                <small>&#8593;</small>\n                <span class=\"maxToday monospaceNumber\">\n                  ").concat(format.convertTemperature(+todayMinMax.high, temperature), "\n                </span>\n              </div>\n            </div>\n          </div>\n          <div class=\"condition\">\n            <img class=\"imgToday\" src=\"images/weather/").concat(src, ".png\" alt=\"").concat(src, "\" />\n            <div>").concat(item.condition.text, "</div>\n          </div>\n        </div>\n        </div>\n        <div class=\"cell descriptionAtmosphere\">\n          <div class=\"content\">\n            <span class=\"title\">humidity</span>\n            <span class=\"humidity monospaceNumber\">").concat(atmosphere.humidity, "%</span>\n          </div>\n          <div class=\"content\">\n            <span class=\"title\">pressure</span>\n            <span class=\"pressure monospaceNumber\">\n              ").concat(atmosphere.pressure.toFixed(0), "\n              mbar ").concat(getRising(+atmosphere.rising), "\n            </span>\n          </div>\n          <div class=\"content\">\n            <span class=\"title\">visibility</span>\n            <span class=\"visibility monospaceNumber\">").concat(!atmosphere.visibility ? 'n/d' : format.getWindStrength(atmosphere.visibility, speed, ''), "</span>\n          </div>\n          <div class=\"content\">\n            <span class=\"title\">wind</span>\n            <span class=\"wind monospaceNumber\">").concat(format.getWindStrength(wind.speed, speed, '/h'), "</span>\n            <span class=\"windDirection\">").concat(format.getDirectionWind(+wind.direction), "</span>\n          </div>\n          <div class=\"content\">\n            <span class=\"title\">sunrise</span>\n            <span class=\"sunrise monospaceNumber\">\n              ").concat(format.getCurrentTime(new Date(sunrise * 1000), timeFormat), "\n            </span>\n          </div>\n          <div class=\"content\">\n            <span class=\"title\">sunset</span>\n            <span class=\"sunset monospaceNumber\">\n              ").concat(format.getCurrentTime(new Date(sunset * 1000), timeFormat, 'pm'), "\n            </span>\n          </div>\n        </div>\n        <div class=\"wrapperForecast\">\n          <div class=\"blockForecast\">\n            <div class=\"titleForecast\">Forecast</div>\n            <ul class=\"listForecast\">\n              ").concat(createForecast(forecast, temperature), "\n            </ul>\n          </div>\n        </div>\n      </div>");
  return template;
}
;
...
var serverApi = {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            url = "https://api.teleport.org/api/cities/?search=".concat(substring, "&limit=").concat(LIMIT_CITIES_BY_SUBSTRING);
            _context.prev = 1;
            _context.next = 4;
  ...
  getWeather: function getWeather(place) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return getServerData("/get-weather?location=".concat(place));
          case 3:
  ...
  getIsoAlpha: function getIsoAlpha(geonameid) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var response, isoAlpha2, url;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            url = "https://api.teleport.org/api/cities/geonameid:".concat(geonameid, "/");
            _context4.prev = 1;
            _context4.next = 4;
            return getServerData(url);
          case 4:
          ...
          case 10:
            ...
            response = false;
          case 14:
            return _context4.abrupt("return", isoAlpha2 || false);
          case 15:
          case "end":
...
function _getServerData() {
  _getServerData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(url) {
...
module.exports = {
  ...
  updateItemWeather: function updateItemWeather(newWeather) {
    var _this2 = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
  ...
  setCurrentSity: function setCurrentSity(id) {
    var _this5 = this;
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            throw new Error("".concat(id, " unknow id"));
          case 9:
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            _context6.next = 7;
            return localforage.setItem(STORAGE_NAME, {
              settings: settings,
              listWeather: [],
              currentSity: ''
            });
...
var pubsub = new (__webpack_require__(/*! ./utils/pubSub */ "./src/js/utils/pubSub.js"))();
var serverApi = __webpack_require__(/*! ./serverApi */ "./src/js/serverApi.js");
var storage = __webpack_require__(/*! ./storage */ "./src/js/storage.js");
var units = {
  distance: "mi",
  pressure: "in",
  speed: "mph",
...
var errorMessages = {
  unknow: function unknow(msg) {
    return msg || "Oops! \n Something went wrong. \n Please try again";
  },
  unknowCiti: function unknowCiti(siti) {
    return "Weather for \"".concat(siti, "\" is not available");
  },
  weatherAdded: function weatherAdded(siti) {
    return "Weather for \"".concat(siti, "\" already exists");
  },
...
var store = {
  ...
  invisibilityTime: 0,
  addNewCiti: function addNewCiti(link, name, geonameid) {
    var _this = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var city, weather;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            name = name.split(',');
            name = "".concat(name[0], ",").concat(name[2] || name[1]);
            _context.next = 5;
  ...
  getWeatherForCity: function getWeatherForCity() {
    var _this2 = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var weatherList, response, itemWeather, cityName;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
          ...
          case 6:
            ...
            itemWeather = getItemWeatherByKey(weatherList, 'id', _this2.currentCitiId);
            cityName = itemWeather.location.nameAlfa2Iso ? itemWeather.location.nameAlfa2Iso : itemWeather._name;
            _context2.next = 11;
            return serverApi.getWeather(cityName);
          case 11:
            response = _context2.sent;
            if (response.status) {
              _context2.next = 15;
  ...
  setWeatherCard: function setWeatherCard(response, num) {
    ...
    var forecast = response.forecasts;
    if (response.fullName) {
      location.regionFullName = response.fullName.split(',')[1];
      location.nameAlfa2Iso = "".concat(location.city, ", ").concat(location.region);
    }
    return {
      units: units,
      astronomy: astronomy,
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            if (response.count > 0) _this3.memoryCities[substring] = list;
            _context3.next = 15;
            break;
          case 12:
            _context3.prev = 12;
  ...
  getWeatherByISOCode: function getWeatherByISOCode(fullName, geoId) {
    var _this4 = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt("return", new Promise(function (resolve, reject) {
              serverApi.getIsoAlpha(geoId).then(function (isoAlpha) {
                var cityName = fullName.match(/[a-zA-Z]+?,/i)[0];
                serverApi.getWeather("".concat(cityName, " ").concat(isoAlpha), geoId).then( /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(response) {
                    ...
                    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                      while (1) switch (_context4.prev = _context4.next) {
                        case 0:
                          _context4.next = 2;
                          return _this4.addNewCiti(undefined, "".concat(cityName, " ").concat(isoAlpha), geoId);
                        case 2:
                          data = _context4.sent;
  ...
  init: function init() {
    ...
    document.addEventListener('visibilitychange', function () {
      if (!document.hidden) {
        if (Date.now() - _this5.invisibilityTime > LAST_UPDATE_TIME) {
          _this5.updateWeather();
        }
      } else _this5.invisibilityTime = Date.now();
    }, false);
    window.addEventListener('online', function () {
      _this5.onlineStatus = true;
    });
    window.addEventListener('offline', function () {
      _this5.onlineStatus = false;
      _this5.listSities = [];
      _this5.memoryCities = {};
      pubsub.publish('create-list-cityes', _this5.listSities);
      pubsub.publish('show-message', {
        message: errorMessages.offline()
      });
    });
    pubsub.subscribe('clicked-close-block-search', function () {
      _this5.isShowBlockSearch = !_this5.isShowBlockSearch;
    ...
    pubsub.subscribe('add-card-weather', function () {
      _this5.isShowBlockSearch = !_this5.isShowBlockSearch;
      pubsub.publish('show-block-search');
      if (!_this5.isCardWeather) _this5.showHidePulsing(true);
    });
    pubsub.subscribe('new-substring-on-search-cityes', function (data) {
      if (!_this5.onlineStatus) return showMessage('offline');
      pubsub.publish('disabled-cityes-not-found');
      _this5.notFound = false;
      var substring = data.key;
      if (!substring) pubsub.publish('create-list-cityes', []);else if (_this5.memoryCities[substring]) {
        _this5.listSities = _this5.memoryCities[substring];
        pubsub.publish('create-list-cityes', _this5.listSities);
      } else {
        _this5.listSities = [];
        pubsub.publish('create-list-cityes', _this5.listSities);
        pubsub.publish('start-load-list-sities');
        _this5.getCitiesBySubstring(substring).then(function (response) {
          pubsub.publish('stop-load-list-sities');
          if (!response) {
            pubsub.publish('hide-block-search');
            pubsub.publish('show-message', {
              message: errorMessages.unknow()
            });
          } else if (response.length > 0) {
            _this5.listSities = response;
            pubsub.publish('create-list-cityes', _this5.listSities);
    ...
    pubsub.subscribe('selected-city', function (data) {
      if (_this5.notFound) return;
      _this5.memoryCities = {};
      var selectedSiti = _this5.listSities[+data.index];
      ...
      pubsub.publish('hide-block-search');
      pubsub.publish('create-list-cityes', _this5.listSities);
      if (_this5.weatherFor.includes(geoId)) {
        pubsub.publish('show-message', {
          message: errorMessages.weatherAdded(fullName)
        });
        return;
      }
      pubsub.publish('start-load-card-weather');
      _this5.addNewCiti(link, fullName, geoId).then( /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(response) {
          var res, _response$location, city, country;
          return _regeneratorRuntime().wrap(function _callee6$(_context6) {
            while (1) switch (_context6.prev = _context6.next) {
              case 0:
                ...
                return _context6.abrupt("return", showMessage('unknow'));
              case 3:
                ...
                _context6.next = 6;
                return _this5.getWeatherByISOCode(fullName, geoId);
              case 6:
                response = _context6.sent;
                _response$location = response.location, city = _response$location.city, country = _response$location.country;
                response.fullName = fullName;
                response.geonameid = geoId;
                response._name = "".concat(city, ", ").concat(country);
                if (!response.current_observation) {
                  showMessage('unknowCiti', response._name);
                  pubsub.publish('show-block-search');
                  if (_this5.currentCitiId) _this5.setNewCity(_this5.currentCitiId);
                }
                return _context6.abrupt("return", response);
              case 13:
                return _context6.abrupt("return", response);
    ...
    pubsub.subscribe('delete-card', function (data) {
      ...
      storage.deleteItem(id).then(function (response) {
        if (!response) showMessage('unknow');else {
          var card = response[0];
          if (card.id === _this5.currentCitiId) {
            _this5.currentCitiId = undefined;
            _this5.lastUpdateTime = undefined;
            pubsub.publish('delete-weather-card');
          }
          var index = _this5.weatherFor.indexOf(card.geonameid);
          if (index < 0) console.error("non-existent geographical name ".concat(card));else {
            _this5.weatherFor.splice(index, 1);
            if (!_this5.weatherFor.length) pubsub.publish('hide-saved-cities');
          }
        }
      });
    });
    ...
    pubsub.subscribe('new-settings', function (data) {
      if (!_this5.settings[data.key]) throw new Error("".concat(data.key, " unknow value"));
      storage.setSettings(data).then(function (response) {
        var _loop = function _loop(key) {
          if (_this5.settings[key] !== response.settings[key]) {
            _this5.settings[key] = response.settings[key];
            response.listWeather.some(function (item) {
              if (item.id === _this5.currentCitiId) {
                pubsub.publish("update-units-".concat(key), [item]);
                return true;
              } else return false;
            });
          }
    ...
    pubsub.subscribe('change-current-city', function (data) {
      var id = data.id;
      if (!id) {
        console.error("unknow id ".concat(id));
        showMessage('unknow');
      }
      if (_this5.currentCitiId === id) return;
      _this5.setNewCity(id);
    });
    pubsub.subscribe('saved-cityes-closed', function () {
      if (_this5.currentCitiId) return;
      storage.getStorage().then(function (response) {
        var city = response.listWeather[0];
        if (city) _this5.setNewCity(city.id);
      });
    });
  },
  setNewCity: function setNewCity(id) {
    ...
    storage.setCurrentSity(id).then(function (response) {
      ...
      _this6.currentCitiId = response.id;
      _this6.lastUpdateTime = response.city._updated;
      pubsub.publish('create-card-weater', response.city);
      var isUpdate = isTimeToUpdate(_this6.lastUpdateTime);
      if (isUpdate) _this6.updateWeather();
    });
  },
  ...
  changeCurrentCity: function changeCurrentCity(id) {
    var _this8 = this;
    return storage.setCurrentSity(id).then(function (response) {
      if (!response) showMessage('unknow');
      _this8.currentCitiId = response.id;
      return _this8.currentCitiId;
    });
  },
  initApp: function initApp() {
    var _this9 = this;
    storage.init(this.settings).then( /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(response) {
        var settings, listWeather, itemWeather, isUpdate;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              settings = response.settings, listWeather = response.listWeather;
              _this9.settings = settings;
              _this9.weatherFor = listWeather.map(function (item) {
                return item.geonameid;
              });
              _this9.isCardWeather = listWeather.length > 0 ? true : false;
              _this9.showHidePulsing(_this9.isCardWeather);
              if (response.currentSity) _this9.currentCitiId = response.currentSity;
              if (!(listWeather.length > 0)) {
                _context7.next = 16;
                break;
              }
              if (_this9.currentCitiId) {
                _context7.next = 10;
                break;
              }
              _context7.next = 10;
              return _this9.changeCurrentCity(listWeather[0].id);
            case 10:
              pubsub.publish('create-list-saved-sities', listWeather);
              itemWeather = getItemWeatherByKey(listWeather, 'id', _this9.currentCitiId);
              _this9.lastUpdateTime = itemWeather._updated;
              pubsub.publish('create-card-weater', itemWeather);
              isUpdate = isTimeToUpdate(_this9.lastUpdateTime);
              if (isUpdate) _this9.updateWeather();
            case 16:
              pubsub.publish('set-current-settings', {
                settings: settings
              });
            case 17:
            case "end":
...
var showMessage = function showMessage(key, message) {
  if (message) pubsub.publish('show-message', {
    message: errorMessages[key](message)
  });else pubsub.publish('show-message', {
...
/***/ "./src/js/utils/SelectItemList.js":
/*!****************************************!*\
  !*** ./src/js/utils/SelectItemList.js ***!
  \****************************************/
/***/ (function(module) {
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var pubsub = new (__webpack_require__(/*! ./pubSub */ "./src/js/utils/pubSub.js"))();
var INCLINE = 60; //px
var Swipedetect = /*#__PURE__*/function () {
...
var format = {
  ...
  convertTemperature: function convertTemperature(deg, prefix) {
    if (prefix === 'c') return deg.toFixed(0) + ' °C';else return (deg * 9 / 5 + 32).toFixed(0) + ' °F';
  },
  getWindStrength: function getWindStrength(windSpeed, prefix, inHours) {
    if (prefix === 'km') return "".concat((windSpeed * 3.6).toFixed(1), " km").concat(inHours);else return "".concat((+windSpeed * MILE).toFixed(1), " mi").concat(inHours);
  },
  ...
  formateDateForecast: function formateDateForecast(ms) {
    ...
    return "".concat(date[0], " ").concat(date[2], " ").concat(date[1], " ").concat(date[3]);
  },
...
/*!*************************!*\
  ...
  \*************************/
var store = __webpack_require__(/*! ./store */ "./src/js/store.js");
var WeatherCard = __webpack_require__(/*! ./components/WeatherCard */ "./src/js/components/WeatherCard.js");
var Header = __webpack_require__(/*! ./components/Header */ "./src/js/components/Header.js");
var BlockSearch = __webpack_require__(/*! ./components/BlockSearch */ "./src/js/components/BlockSearch.js");
var ListSities = __webpack_require__(/*! ./components/ListSities */ "./src/js/components/ListSities.js");
var Message = __webpack_require__(/*! ./components/Message */ "./src/js/components/Message.js");
var NotFound = __webpack_require__(/*! ./components/NotFound */ "./src/js/components/NotFound.js");
var Menu = __webpack_require__(/*! ./components/Menu */ "./src/js/components/Menu.js");
var SavedCities = __webpack_require__(/*! ./components/SavedCities */ "./src/js/components/SavedCities.js");
new BlockSearch({
  container: document.querySelector('.blockSearch')
});
new Header({
  container: document.querySelector('.header')
});
new ListSities({
  container: document.querySelector('.listSities')
});
new Message({
  container: document.querySelector('.containerMessage')
});
new WeatherCard({
  container: document.querySelector('.listCardWeater')
});
new NotFound({
...
new SavedCities({
  container: document.querySelector('.blockSavedCities')
});
store.initApp();
