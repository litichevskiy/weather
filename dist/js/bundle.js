...
var pubsub = new (__webpack_require__(28))();
var serverApi = __webpack_require__(130);
var storage = __webpack_require__(136);
var errorMessages = {
...
var store = {
  ...
  addNewCiti: function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(link, name, geonameid) {
      var city, weather, _city$location$latlon, latitude, longitude;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt('return', console.error('link ' + link + ' can not be empty'));

            case 2:
              city = void 0, weather = void 0;
              _context.prev = 3;
              _context.next = 6;
              return serverApi.getCity(link);
            ...
            case 9:
              _city$location$latlon = city['location']['latlon'], latitude = _city$location$latlon.latitude, longitude = _city$location$latlon.longitude;
              ...
              return _context.abrupt('return', console.error('latitude ' + latitude + ' and longitude ' + longitude + ' can not be empty'));

            case 12:
              _context.next = 14;
              return serverApi.getWeather('(' + latitude + ', ' + longitude + ')');
  ...
  getWeather: function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(coord) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt('return', console.error('coord ' + coord + ' can not be empty'));

            case 2:
              _context2.next = 4;
              return serverApi.getWeather(coord);
  ...
  updateWeatherCities: function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      var weatherList, response, coord, result, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item;

      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              weatherList = void 0, response = void 0, coord = void 0, result = [];
              _context3.prev = 1;
              _context3.next = 4;
            ...
            case 7:
              ...
              _context3.prev = 11;
              _iterator = weatherList[Symbol.iterator]();
            ...
            case 13:
              ...
              coord = item.coord;
              _context3.next = 18;
              return this.getWeather('(' + coord.lat + ', ' + coord.long + ')');
      ...
      }, _callee3, this, [[1, 45], [11, 31, 35, 43], [36,, 38, 42]]);
    }));
    ...
    return updateWeatherCities;
  }(),
  setWeatherCard: function setWeatherCard(response, num) {
    var astronomy = response.astronomy,
        atmosphere = response.atmosphere,
        location = response.location,
        units = response.units,
        wind = response.wind,
        item = response.item,
        _name = response._name,
        geonameid = response.geonameid;

    var condition = item.condition;
    var id = num || createId();
    var lastUpdate = new Date();
    var forecast = item.forecast.splice(0, 6);
    var coord = { lat: item.lat, long: item.long };
    return {
      coord: coord, astronomy: astronomy, atmosphere: atmosphere,
      location: location, units: units, wind: wind, item: { condition: condition, forecast: forecast },
      lastUpdate: lastUpdate, id: id, geonameid: geonameid, _name: _name
    };
  },
  getCitiesBySubstring: function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(substring) {
      var response, list;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt('return', console.error('substring can not be empty'));
    ...
    function getCitiesBySubstring(_x5) {
  ...
  init: function init() {
    ...
    pubsub.subscribe('selected-city', function (data) {
      ...
      _this.addNewCiti(link, fullName, geoId).then(function (response) {
        ...
        if (!response.item) return showMessage('unknowCiti', response._name);else {
    ...
    pubsub.subscribe('update-all-weather-card', function () {
      if (!_this.onlineStatus) return showMessage('offline');
      pubsub.publish('start-updated-all-weather-card');
      _this.updateWeatherCities().then(function (response) {
        if (!response) {
          ...
          response.forEach(function (item) {
            var id = item.id;
            var weatherCard = _this.setWeatherCard(item, id);
            storage.updateItem(id, weatherCard).then(function (response) {
              if (!response) return showMessage('unknow');else pubsub.publish('update-card-weater', weatherCard);
            });
          });
          pubsub.publish('end-updated-all-weather-card');
        }
    ...
    pubsub.subscribe('delete-card', function (data) {
      ...
      storage.deleteItem(id).then(function (response) {
        if (!response) showMessage('unknow');else {
          ...
          if (index < 0) console.error('nonexistent name ' + card);else _this.weatherFor.splice(index, 1);
        }
      });
    });

    pubsub.subscribe('init-app', function (list) {
      _this.weatherFor = list.map(function (item) {
        return item.geonameid;
      });
      _this.isCardWeather = list.length > 0 ? true : false;
      _this.showHidePulsing(_this.isCardWeather);
    });
...
var serverApi = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return getServerData('https://api.teleport.org/api/cities/?search=' + substring);
  ...
  getWeather: function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(coord) {
      var url, YQL, response;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              url = 'https://query.yahooapis.com/v1/public/yql?q=';
              YQL = 'select * from weather.forecast where woeid in (select woeid from geo.places(1) where text="' + coord + '")';

              YQL = encodeURIComponent(YQL) + '&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys';
              response = void 0;
              _context3.prev = 4;
              _context3.next = 7;
              return getServerData(url + YQL);
...
var localforage = __webpack_require__(362);
...
module.exports = {
  ...
  updateItem: function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, newData) {
      var response, index;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              response = void 0, index = void 0;
              _context2.prev = 1;
              _context2.next = 4;
              return this.getStorage();
  ...
  setSettings: function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(settings) {
      var response;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
  ...
  init: function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(settings) {
      var response;
...
var serverApi = __webpack_require__(130);
var storage = __webpack_require__(136);
var WeathersList = __webpack_require__(363);
var Header = __webpack_require__(367);
var BlockSearch = __webpack_require__(368);
var ListSities = __webpack_require__(370);
var Message = __webpack_require__(372);
var NotFound = __webpack_require__(373);
var Menu = __webpack_require__(374);
...
storage.init(store.settings).then(function (response) {
  ...
  var listWeather = response.listWeather,
      settings = response.settings;

  pubsub.publish('init-app', listWeather);
  store.settings = settings;
  listWeather.forEach(function (item) {
    return pubsub.publish('create-card-weater', item);
  });
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('./dist/js/sw.js').then(function (response) {
    response.update();
...
var pubsub = new (__webpack_require__(28))();
var getParentNode = __webpack_require__(364);
var format = __webpack_require__(365);
var store = __webpack_require__(129);
var Preloader = __webpack_require__(137);
var CODES = __webpack_require__(366);

var dataRoles = {
  'delete': 'deleteCard'
};

var WeathersList = function () {
  function WeathersList(data) {
    var _this = this;

    _classCallCheck(this, WeathersList);
    ...
    this.container.addEventListener('click', function (event) {
      ...
      var action = dataRoles[target.getAttribute('data-role')];
      if (!action) return;
  ...
  _createClass(WeathersList, [{
    ...
    key: 'updateCardWeater',
    value: function updateCardWeater(data) {
      var card = this.container.querySelector('[data-id="' + data.id + '"]');
      card.innerHTML = templateCard(data);
    }
  }, {
    key: 'deleteCard',
    value: function deleteCard(target) {
      var card = getParentNode(target, 'LI');
    ...
    value: function updateTemperature(list) {
      ...
      list.forEach(function (data) {
        ...
        card.querySelector('.temperatureToday').innerHTML = format.convertTemperature(+data.item.condition.temp, temperature);
...
var pubsub = new (__webpack_require__(28))();
var ButtonImg = __webpack_require__(51);
...
var pubsub = new (__webpack_require__(28))();
var InputSearch = __webpack_require__(369);
var ButtonImg = __webpack_require__(51);
var Preloader = __webpack_require__(137);
var ESC = 27; // keyCode;
...
var pubsub = new (__webpack_require__(28))();
var SelectItemList = __webpack_require__(371);
...
var Menu = function () {
  ...
  _createClass(Menu, [{
    ...
    value: function saveSettings(event) {
      ...
      var settings = [].concat(_toConsumableArray(event.target.querySelectorAll('input:checked')));
      settings = settings.reduce(function (data, item) {
